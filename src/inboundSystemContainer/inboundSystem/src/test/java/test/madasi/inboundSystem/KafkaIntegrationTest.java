package test.madasi.inboundSystem;
...
import madasi.inboundSystem.inboundSystemApplication;
import madasi.inboundSystem.service.ConsumerService;
import madasi.inboundSystem.service.ProducerService;


@SpringBootTest(classes = inboundSystemApplication.class) // This will load your full Spring context based on your main application
